...
for i in IAT:
      ...
      OUTPUT_PATH='Performance-Analysis-Wireless-Adhoc-Network\\'+str(foldername)+'\\5-Hop-Network'+'-'+ str(today)+'\\5-Hop_'+'Source rate'+'-'+str(Soure_rate)+'Mbps';
      ...
      if not os.path.exists(OUTPUT_PATH):
       ...
       if(os.path.isfile('result.csv')):
         shutil.copy(os.path.join('result.csv'),'Performance-Analysis-Wireless-Adhoc-Network\\'+str(foldername)+'\\5-Hop-Network'+'-'+ str(today))
